...
# Current operating mode ID constants
CURRENT_OPERATING_MODE_ERROR = -1
CURRENT_OPERATING_MODE_UNDEFINED = 0
CURRENT_OPERATING_MODE_IDLE = 1
CURRENT_OPERATING_MODE_HEATING_ACC = 2
CURRENT_OPERATING_MODE_HEATING_DHW = 3
CURRENT_OPERATING_MODE_DHW_FROM_ACC = 4
CURRENT_OPERATING_MODE_ACC_AND_DHW_FROM_ACC = 5
CURRENT_OPERATING_MODE_DHW_AND_DHW_FROM_ACC = 6

# Current operating mode text constants (for translation keys)
CURRENT_OPERATING_MODE_ERROR_TEXT = "error"
CURRENT_OPERATING_MODE_IDLE_TEXT = "idle"
CURRENT_OPERATING_MODE_HEATING_ACC_TEXT = "heating_acc"
CURRENT_OPERATING_MODE_HEATING_DHW_TEXT = "heating_dhw"
CURRENT_OPERATING_MODE_DHW_FROM_ACC_TEXT = "dhw_from_acc"
CURRENT_OPERATING_MODE_ACC_AND_DHW_FROM_ACC_TEXT = "acc_and_dhw_from_acc"
CURRENT_OPERATING_MODE_DHW_AND_DHW_FROM_ACC_TEXT = "dhw_and_dhw_from_acc"
CURRENT_OPERATING_MODE_UNDEFINED_TEXT = "undefined"

# Options for current operating mode text (for SensorDeviceClass.ENUM)
CURRENT_OPERATING_MODE_TEXT_OPTIONS = [
    CURRENT_OPERATING_MODE_ERROR_TEXT,
    CURRENT_OPERATING_MODE_IDLE_TEXT,
    CURRENT_OPERATING_MODE_HEATING_ACC_TEXT,
    CURRENT_OPERATING_MODE_HEATING_DHW_TEXT,
    CURRENT_OPERATING_MODE_DHW_FROM_ACC_TEXT,
    CURRENT_OPERATING_MODE_ACC_AND_DHW_FROM_ACC_TEXT,
    CURRENT_OPERATING_MODE_DHW_AND_DHW_FROM_ACC_TEXT,
    CURRENT_OPERATING_MODE_UNDEFINED_TEXT,
]
